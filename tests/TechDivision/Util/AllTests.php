...
require_once 'TechDivision/Util/SystemLocaleTest.php';
require_once 'TechDivision/Util/DataSourceTest.php';
 ...
 * @license GPL
 */
class TechDivision_Utils_AllTests
{
    ...
    public static function suite()
    {
        ...
        // add a test
        $suite->addTestSuite('TechDivision_Util_SystemLocaleTest');
        $suite->addTestSuite('TechDivision_Util_DataSourceTest');
